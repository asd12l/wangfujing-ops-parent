...
(function() {
    ...
    function w() {
        ...
        b[0] === true && (d = b[1], b = Array.prototype.slice.call(b, 2));
        c = b.length;
    ...
    function Sa(a, b, c, d) {
        ...
        this.pos = b;
        this.type = c || "";
        this.isNew = true; ! c && !d && this.addLabel()
    }
    function ma() {
    ...
    J = {},
    S;
    H.Highcharts ? oa(16, true) : S = H.Highcharts = {};
    bb = function(a, b, c) {
    ...
    G.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (typeof a === "string") g = (this[a + "Getter"] || this._defaultGetter).call(this, a, e);
                ...
                for (c in a) {
                    d = a[c];
                    h = !1;
                    this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)/.test(c) && (f || (this.symbolAttr(a), f = true), h = true);
                    if (this.rotation && (c === "x" || c === "y")) this.doTransform = true;
        ...
        css: function(a) {
            ...
            if (b) for (f in a) a[f] !== b[f] && (c[f] = a[f], e = true);
            if (e) {
    ...
    ta.prototype = {
        ...
        setSize: function(a, b, c) {
            ...
            this.width = a;
            this.height = b;
            for (this.boxWrapper[p(c, true) ? "animate": "attr"]({
                width: a,
                height: b
            }); e--;) d[e].align()
        },
    ...
    Sa.prototype = {
        ...
        render: function(a, b, c) {
            ...
            this.isActive = true;
            if (o) {
                j = d.getPlotLinePath(j + v, o * y, b, true);
                if (l === t) {
                    l = {
                        stroke: q,
                        "stroke-width": o
    ...
    ma.prototype = {
        ...
        init: function(a, b) {
            ...
            if (a.inverted && c && this.reversed === t) this.reversed = true;
            ...
            function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        a.ignoreMinPadding = true;
                        else if (a.dataMax < d) a.dataMax = d,
                        a.ignoreMaxPadding = true
                    }
                }
            })
        },
        ...
        toPixels: function(a, b) {
            return this.translate(a, !1, !this.horiz, null, true) + (b ? 0 : this.pos)
        },
        toValue: function(a, b) {
            return this.translate(a - (b ? 0 : this.pos), true, !this.horiz, null, true)
        },
        getPlotLinePath: function(a, b, c, d, e) {
            ...
            if (isNaN(e)) m = true;
                ...
                if (i = h, j = k - this.bottom, a < g || a > g + this.width) m = true
            } else if (a = g, c = l - this.right, i < h || i > h + this.height) m = true;
        ...
        getMinorTickPositions: function() {
            ...
            if (this.isLog) {
                e = b.length;
                for (a = 1; a < e; a++) d = d.concat(this.getLogTickPositions(c, b[a - 1], b[a], true))
        ...
        setTickPositions: function(a) {
            ...
            b.min === b.max || b.min === void 0 || b.max === void 0 ? b.tickInterval = 1 : j && !n && Y === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval: (b.tickInterval = p(n, I ? 1 : (b.max - b.min) * Y / u(b.len, Y)), !s(n) && b.len < Y && !this.isRadial && !this.isLog && !I && e && f && (E = true, b.tickInterval /= 4));
            i && !a && q(b.series,
            function(a) {
            ...
            if (!a) ! b.ordinalPositions && (b.max - b.min) / b.tickInterval > u(2 * b.len, 200) && oa(19, true),
            a = h ? b.getTimeTicks(b.normalizeTimeTickInterval(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, true) : g ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max),
        ...
        setScale: function() {
            ...
            q(this.series,
            function(a) {
                if (a.isDirtyData || a.isDirty || a.xAxis.isDirty) d = true
            });
        ...
        getOffset: function() {
            ...
            a.showAxis = k = j || p(d.showEmpty, true);
            ...
            if (j || a.isLinked) {
                ...
                if (a.horiz && !a.staggerLines && w && !Y.rotation) {
                    for (j = a.reversed ? [].concat(e).reverse() : e; v < w;) {
                        ...
                        R = r % v,
                        y && (C = a.translate(C), x[R] !== t && C < x[R] && (z = true), x[R] = C + y);
                        if (z) v++;
                        else break
                    }
        ...
        render: function() {
            ...
            function(b) {
                ...
                D && m[b].isNew && m[b].render(null, true);
                m[b].render(null, !1, 1)
            ...
            function(b, c) {
                ...
                D && l[b].isNew && l[b].render(c, true, 0.1),
                l[b].render(c)
            }), E && a.min === 0 && (l[ - 1] || (l[ - 1] = new Sa(a, -1, null, true)), l[ - 1].render( - 1))), p && q(i,
            function(b, c) {
        ...
        drawCrosshair: function(a, b) {
            if (this.crosshair) if ((s(b) || !p(this.crosshair.snap, true)) === !1) this.hideCrosshair();
            else {
                var c, d = this.crosshair,
                e = d.animation;
                p(d.snap, true) ? s(b) && (c = this.chart.inverted != this.horiz ? b.plotX: this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos: this.len - a.chartY + this.pos;
    ...
    Mb.prototype = {
        ...
        getPosition: function(a, b, c) {
            ...
            n = function() {
                k.apply(0, h) !== !1 ? l.apply(0, i) === !1 && !g && (m(true), n()) : g ? f.x = f.y = 0 : (m(true), n())
    ...
    Va.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                f = [];
                i = c.length;
                for (j = 0; j < i; j++) if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== true && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) e._dist = Q(l - e.clientX),
                k = C(k, e._dist),
                f.push(e);
    ...
    r(S.Pointer.prototype, {
        pinchTranslate: function(a, b, c, d, e, f) { (this.zoomHor || this.pinchHor) && this.pinchTranslateDirection(true, a, b, c, d, e, f); (this.zoomVert || this.pinchVert) && this.pinchTranslateDirection(!1, a, b, c, d, e, f)
        },
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            ...
            c();
            b = p;
            b < D.min ? (b = D.min, x = true) : b + o > D.max && (b = D.max - o, x = true);
    ...
    kb.prototype = {
        ...
        getAllItems: function() {
            ...
            function(b) {
                var c = b.options;
                if (p(c.showInLegend, !s(c.linkedTo) ? t: !1, true)) a = a.concat(b.legendItems || (c.legendType === "point" ? b.data: b))
            });
            return a
        },
        render: function() {
    ...
    Xa.prototype = {
        init: function(a, b) {
            ...
            f.xAxis = [];
            f.yAxis = [];
            f.animation = ga ? !1 : p(d.animation, true);
            f.pointCount = f.colorCounter = f.symbolCounter = 0;
            f.firstRender()
        },
        initSeries: function(a) {
            var b = this.options.chart; (b = J[a.type || b.type || b.defaultSeriesType]) || oa(17, true);
            b = new b;
            b.init(this, a);
            return b
        },
        ...
        redraw: function(a) {
            ...
            for (this.layOutTitles(); l--;) if (a = c[l], a.options.stacking && (g = true, a.isDirty)) {
                h = true;
                break
            }
            if (h) for (l = k; l--;) if (a = c[l], a.options.stacking) a.isDirty = true;
            q(c,
            function(a) {
                a.isDirty && a.options.legendType === "point" && (f = true)
            });
        ...
        getStacks: function() {
            ...
            q(a.series,
            function(b) {
                if (b.options.stacking && (b.visible === true || a.options.chart.ignoreHiddenSeries === !1)) b.stackKey = b.type + p(b.options.stack, "")
            })
        },
        ...
        layOutTitles: function(a) {
            ...
            this.hasRendered && p(a, true) && this.isDirtyBox && this.redraw()
        },
        ...
        getContainer: function() {
            ...
            this.renderer = b.forExport ? new ta(a, c, d, b.style, true) : new Ya(a, c, d, b.style);
        ...
        propFromSeries: function() {
            ...
            function(g) {
                ...
                for (e = d && d.length; ! f && e--;)(c = J[d[e].type]) && c.prototype[g] && (f = true);
                a[g] = f
            })
        },
        linkSeries: function() {
    ...
    Ea.prototype = {
        ...
        optionsToObject: function(a) {
            ...
            if (typeof a === "number" || a === null) b[d[0]] = a;
                ...
                b = a;
                if (a.dataLabels) c._hasPointLabels = true;
                if (a.marker) c._hasPointMarkers = true
            }
            return b
        },
        destroy: function() {
    ...
    O.prototype = {
        ...
        init: function(a, b) {
            ...
            if (e && e.click || b.point && b.point.events && b.point.events.click || b.allowPointSelect) a.runTrackerClick = true;
            c.getColor();
            c.getSymbol();
            q(c.parallelArrays,
            function(a) {
            ...
            c.setData(b.data, !1);
            if (c.isCartesian) a.hasCartesianSeries = true;
            f.push(c);
            c._i = f.length - 1;
            nb(f, g);
        ...
        bindAxes: function() {
            ...
            function(e) {
                ...
                function(c) {
                    ...
                    a[e] = c,
                    c.isDirty = true
                }); ! a[e] && a.optionalAxis !== e && oa(18, true)
            })
        },
        ...
        setData: function(a, b, c, d) {
            ...
            function(a, b) {
                ...
                e.isDirty = e.isDirtyData = j.isDirtyBox = true;
                c = !1
            }
            b && j.redraw(c)
        },
        ...
        drawPoints: function() {
            ...
            a = o && i.enabled === t || i.enabled, m = c.isInsidePlot(v(d), e, c.inverted), a && e !== t && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select": ""] || l, h = a.r, i = p(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[m ? "show": "hide"](true).animate(r({
                x: d - h,
                y: e - h
            },
            k.symbolName ? {
        ...
        getAttribs: function() {
            ...
            if (!i || g < i || k) for (; g--;) {
                ...
                if (i.options) for (p in l) s(c[l[p]]) && (k = true);
                if (k) {
                    c = c || {};
                    k = [];
                    d = c.states || {};
        ...
        clipNeg: function() {
            ...
            l = this.yAxis;
            if (d && (f || g)) {
                d = v(l.toPixels(a.threshold || 0, true));
                d < 0 && (k -= d);
                a = {
                    x: 0,
                    y: 0,
        ...
        redraw: function() {
            ...
            this.translate();
            this.setTooltipPoints && this.setTooltipPoints(true);
            this.render();
    ...
    Fb.prototype = {
        ...
        setOffset: function(a, b) {
            ...
            f = e.alignAttr,
            e[this.options.crop === !1 || d.isInsidePlot(f.x, f.y) ? "show": "hide"](true)
        }
    };
    ma.prototype.buildStacks = function() {
        var a = this.series,
        b = p(this.options.reversedStacks, true),
        c = a.length;
        if (!this.isXAxis) {
    ...
    O.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== true && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            if (e === "percent") k.usePercentage = true;
            this.stackedYData = c;
            k.oldStacks = {}
        }
    };
    ...
    r(Ea.prototype, {
        update: function(a, b, c) {
            ...
            function() {
                ...
                j.data[g] = d.options;
                e.isDirty = e.isDirtyData = true;
                if (!e.fixedBox && e.hasCartesianSeries) i.isDirtyBox = true;
    ...
    r(O.prototype, {
        addPoint: function(a, b, c, d) {
            ...
            g = d.x;
            h = n.length;
            if (this.requireSorting && g < n[h - 1]) for (m = true; h && n[h - 1] > g;) h--;
    ...
    T = {
        ...
        pointClass: la(Ea, {
            ...
            setVisible: function(a) {
                ...
                function(c) {
                    if (b[c]) b[c][a ? "show": "hide"](true)
                });
                b.legendItem && d.legend.colorizeItem(b, a);
                if (!c.isDirty && c.options.ignoreHiddenPoint) c.isDirty = true,
                d.redraw()
            },
    ...
    O.prototype.drawDataLabels = function() {
        ...
        !a.hasRendered && p(d.defer, true) && (i.attr({
            opacity: 0
        }), N(a, "afterAnimate",
        function() {
            a.visible && i.show();
    ...
    O.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        c.rotation ? b[e ? "attr": "animate"]({
            ...
            align: c.align
        }) : (b.align(c, null, d), g = b.alignAttr, p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : p(c.crop, true) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)));
        if (!a) b.attr({
            y: -999
        }),
        b.placed = !1
    ...
    J.pie.prototype.placeDataLabels = function() {
        ...
        function(a) {
            var a = a.dataLabel,
            b;
            if (a)(b = a._pos) ? (a.attr(a._attr), a[a.moved ? "animate": "attr"](b), a.moved = true) : a && a.attr({
                y: -999
            })
        })
    },
    ...
    J.pie.prototype.verifyDataLabelOverflow = function(a) {
        ...
        }), this.drawDataLabels && this.drawDataLabels()) : f = true;
        return f
    };
    ...
    r(Xa.prototype, {
        ...
        pan: function(a, b) {
            ...
            function(b) {
                ...
                j = (h.pointRange || 0) / 2,
                k = h.getExtremes(),
                l = h.toValue(i - d, true) + j,
                i = h.toValue(i + c[b ? "plotWidth": "plotHeight"] - d, true) - j;
