    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                data.spuCode = spuCode_ueditor;
                data.colorSid = colorSid_ueditor;
            });
    ...
    OnlineImage.prototype = {
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                ajax.request(url, {
                    ...
                    'data': utils.extend({
                            ...
                            size: this.listSize,
                            spuCode: spuCode_ueditor,
                            colorSid: colorSid_ueditor
        ...
        pushData: function (list) {
            var i, item, img, icon, _this = this,
                ...
                urlListfix = editor.getOpt('imageManagerListPath');
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    img.width = 113;/*console.log(list[i].url);*/
                    imgUrl = urlPrefix + list[i].url.split(urlListfix)[1];/*console.log(imgUrl);*/// + (list[i].url.indexOf('?') == -1 ? '?noCache=':'&noCache=') + (new Date()).valueOf() 
                    img.setAttribute('src', imgUrl+"?"+(new Date()).valueOf());
