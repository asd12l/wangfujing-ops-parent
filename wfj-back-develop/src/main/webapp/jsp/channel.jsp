...
<title>频道管理</title>
  ...
  <script type="text/javascript" src="${ctx}/sysjs/xuanpin/addvalueproduct.js"></script>
  ...
  <script type="text/javascript" src="${ctx}/sysjs/xuanpin/pagelayout-updateContent.js"></script>
