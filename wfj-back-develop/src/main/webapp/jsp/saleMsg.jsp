...
<title>信息发布</title>
  ...
  <script type="text/javascript" src="${ctx}/sysjs/salesmsg/saleMsg.js"></script>
  <script type="text/javascript" src="${ctx}/sysjs/salesmsg/addSaleMsg.js"></script>
  <script type="text/javascript" src="${ctx}/sysjs/salesmsg/updateSaleMsg.js"></script>
