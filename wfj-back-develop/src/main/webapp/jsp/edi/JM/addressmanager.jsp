...
<script type="text/javascript">
	...
	function zTreeOnClick(e, treeId, treeNode) {
		...
		$.ajax({
			type : "post",
			url : __ctxPath + "/receiptAddress/queryAddressInfo?channel=C8",
			data : _requestData,
			dataType : "json",
			success : function(resJSON) {
				...
				var url = __ctxPath
						+ "/receiptAddress/queryWFJProperties?type=TMALL_AREA&channel=C8";
				$.ajax({
					type : "post",
					url : url,
					dataType : "json",
	...
	var _setting = {
		...
		async : {
			enable : true,
			url : __ctxPath + "/receiptAddress/queryAddress?channel=C8",
	...
	var topTree = {
			id:"36adfdb80f014112972b779ab51266d3",
	   		isParent:true,
	   		name:"聚美地区对应",
	   		title:"地区"
	};
	...
	var _updateParam = function(callback) {
		...
		LA.env = 'dev';
		  ...
		  LA.log('jm-address-modify', '聚美收货地址修改', userName, sessionId);
		...
		$.ajax({
			type : "post",
			url : __ctxPath + "/receiptAddress/updateAddress?channel=C8",
			data : _requestData,
			dataType : "json",
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">聚美地址管理</h5>
