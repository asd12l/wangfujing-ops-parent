...
<script type="text/javascript">
	...
	function olvQuery(){
		...
		LA.log('tm-blSearch', '天猫订单黑名单', userName, sessionId);
	...
	function removeBL(tid){
		...
		LA.log('tm-removeBL', '天猫解除黑名单', userName, sessionId);
       	 $.ajax({
       		on: true,
    			url : __ctxPath + "/ediOrder/blacklistRemove?tid="+tid+"&channelCode=C7",
    			dataType : "json",
	...
	function initStock() {
		var url = __ctxPath+"/ediOrder/selectOrderList?ispreSale=BL&tradesource=C7";
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">天猫订单黑名单</h5>
