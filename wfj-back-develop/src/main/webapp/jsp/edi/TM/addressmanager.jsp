...
<script type="text/javascript">
	...
	function zTreeOnClick(e, treeId, treeNode) {
		...
		$.ajax({
			type : "post",
			url : __ctxPath + "/receiptAddress/queryAddressInfo",
			data : _requestData,
			dataType : "json",
			success : function(resJSON) {
				...
				var url = __ctxPath
						+ "/receiptAddress/queryWFJProperties?type=TMALL_AREA";
				$.ajax({
					type : "post",
					url : url,
					dataType : "json",
	...
	var _setting = {
		...
		async : {
			enable : true,
			url : __ctxPath + "/receiptAddress/queryAddress",
	...
	var _updateParam = function(callback) {
		...
		LA.env = 'dev';
		  ...
		  LA.log('tmall-address-modify', '阿里收货地址修改', userName, sessionId);
		...
		$.ajax({
			type : "post",
			url : __ctxPath + "/receiptAddress/updateAddress",
			data : _requestData,
			dataType : "json",
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">天猫地址管理</h5>
