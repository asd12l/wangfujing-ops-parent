...
<script type="text/javascript">
	...
	function olvQuery() {
		...
		LA.log('tm-search', '天猫搜索', userName, sessionId);
	...
	function exportexcle() {
		...
		LA.sysCode = '44';
		var sessionId = '<%=request.getSession().getId()%>';
		LA.log('tm-export', '天猫导出订单', userName,  sessionId);
		$("#tid_form").val($("#tid_input").val());
		$("#ordersId_form").val($("#ordersId_input").val());
		$("#receiverName_form").val($("#receiverName_input").val());
		$("#title_form").val($("#goodName_input").val());
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">天猫订单查询</h5>
								...
								<div class="table-toolbar">
									<div class="table-toolbar">
										<ul class="topList clearfix">
											<li class="col-md-4"><label class="titname">天猫订单编号：</label>
											...
											<li class="col-md-4"><label class="titname">状态：</label>
												<select id="status_select" style="padding: 0 0;">
											...
											<li class="col-md-6"><label class="titname">订单金额：</label>
												<select id="payMent_select">
													<option value="">全部</option>
													<option>&lt;=</option>
													<option>&gt;=</option>
											</select> <!-- <input type="text" id="amount_input" /> --> <input
												type="text" id="amount_input" /></li>
									...
									<div class="pull-left" style="margin-top: 5px;">
										<form id="stock_form" action="">
											...
											<input type="hidden" id="title_form" name="goodName" /> <input
												...
												type="hidden" id="amonut_form" name="totalAmount" /> <input
