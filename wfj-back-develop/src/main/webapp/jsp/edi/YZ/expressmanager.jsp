...
<script type="text/javascript">
	...
	function zTreeOnClick(e, treeId, treeNode) {
		...
		$.ajax({
			type : "post",
			url : __ctxPath+"/express/queryExpressInfo?channel=M4",
			data : _requestData,
			dataType : "json",
	...
	var _setting = {
		...
		async : {
			enable : true,
			url : __ctxPath + "/express/queryExpress?channel=M4",
	...
	var _updateParam = function(callback) {
		...
		$.ajax({
			type : "post",
			url : __ctxPath + "/express/updateExpress?channel=M4",
			data : _requestData,
			dataType : "json",
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">有赞快递管理</h5>
