   ...
   function reloadjs(){
	...
	//初始化包装单位列表
 	function initOlv(tid) {
		var url = __ctxPath+"/ediYzOrder/selectYzOrderItemList?tid="+tid;
  	...
  	function save(){
 	    ...
 	    for(var i = 0; i< salecodeT.length; i++)
 		{
  		...
  		$.ajax({
	        ...
	        url:__ctxPath + "/ediYzOrder/updatechild",
	        async : false,
			ajaxStart : function() {
	...
	function retException(){
		var url = __ctxPath + "/jsp/edi/YZ/orderabnormal.jsp";
		$("#pageBody").load(url);
	}
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">有赞行项目修改</h5>
