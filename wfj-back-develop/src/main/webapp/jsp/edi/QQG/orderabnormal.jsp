...
<script type="text/javascript">
	...
	function modify(tid){
		var url = __ctxPath + "/jsp/edi/QQG/modifyorder.jsp?tid="+tid;
		$("#pageBody").load(url);
	}
	function olvQuery(){
	...
	function initStock() {
		var url = __ctxPath+"/ediOrder/selectOrderList?status=EC&tradesource=CB";
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">全球购异常订单</h5>
