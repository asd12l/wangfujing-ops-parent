...
<script type="text/javascript">
	...
	function exportexcle(){
		...
		if (count > 0){
			...
			form.attr("method","post");
 			form.attr('action', $("#ctxPath").val() + "/ediOrder/exportExcle?tradesource=CB");
 			form.submit();
			/* window.open($("#ctxPath").val() + "/ediOrder/exportExcle?tradesource=CB&&tid="+tid+"&&ordersId="+ordersId
	...
	function initStock() {
		var url = $("#ctxPath").val()+"/ediOrder/selectOrderList?tradesource=CB";
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">全球购订单查询</h5>
							...
							<div class="widget-body" id="pro">
								...
								<div class="table-toolbar">
									<ul class="topList clearfix">
										<li class="col-md-4"><label class="titname">全球购订单编号：</label>
								...
								<table class="table table-bordered table-striped table-condensed table-hover flip-content" id="stock_tab">
                                       <thead class="flip-content bordered-darkorange">
										<tr role="row">
													...
													<th style="text-align: center;">全球购订单编号</th>
													<!-- tid -->
