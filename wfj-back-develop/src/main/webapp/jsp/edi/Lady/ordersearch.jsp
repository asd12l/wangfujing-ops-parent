...
<script type="text/javascript">
	...
	function olvQuery(){
		LA.env = 'dev';
		  ...
		  LA.log('lady-search', '爱逛街订单查询', userName, sessionId);
	...
	function exportexcle(){
		LA.env = 'dev';
		  LA.sysCode = '44';
		  var sessionId = '<%=request.getSession().getId()%>';
		  LA.log('lady-search', '爱逛街导出订单', userName, sessionId);
		$("#tid_form").val($("#tid_input").val());
		$("#ordersId_form").val($("#ordersId_input").val());
		$("#receiverName_form").val($("#receiverName_input").val());
		$("#title_form").val($("#goodName_input").val());
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">爱逛街订单查询</h5>
							...
							<div class="widget-body" id="pro">
								...
								<div class="table-toolbar">
									<ul class="topList clearfix">
										<li class="col-md-4"><label class="titname">爱逛街订单编号：</label>
