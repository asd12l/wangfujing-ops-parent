...
<script type="text/javascript">
	...
	function olvQuery(){
		...
		LA.log('lady-hlSearch', '爱逛街订单黑名单', userName, sessionId);
  ...
  //解除黑名单
	function removeBL(tid){
		...
		LA.sysCode = '44';
		var sessionId = '<%=request.getSession().getId()%>';
		LA.log('lady-removeBL', '爱逛街解除黑名单', userName, sessionId);
       	 $.ajax({
       		on: true,
    			url : __ctxPath + "/ediOrder/blacklistRemove?tid="+tid+"&channelCode=CA",
    			dataType : "json",
	...
	function initStock() {
		var url = __ctxPath+"/ediOrder/selectOrderList?ispreSale=BL&tradesource=CA";
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">爱逛街订单黑名单</h5>
