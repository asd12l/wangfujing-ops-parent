...
<script type="text/javascript">
	...
	function stockQuery() {
		LA.env = 'dev';
		  ...
		  LA.log('lady-refund-search', '爱逛街退单查询', userName, sessionId);
	...
	function initStock() {
		var url = $("#ctxPath").val() + "/refund/obtain?type=Lady";
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<h5 class="widget-caption">爱逛街退单查询</h5>
											...
											{#foreach $T.list as Result}
												<tr class="gradeX">
													...
													<td align="center" >
													   ...
													   {#else} {$T.Result.sid}
													   {#/if}													
													</td>													<td align="center" id="productCode_{$T.Result.sid}">{$T.Result.receiverName}</td>
