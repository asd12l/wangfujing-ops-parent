...
<script type="text/javascript">
	...
	$(function(){
		$("#colorSid_").val(colorSid);
		$("#colorName_").val(colorName_);
		$("#colorAlias_").val(colorAlias_);
  		$("#save").click(function(){
  			saveFrom();
  		});
						...
						<div class="widget radius-bordered">
							...
							<div class="widget-body">
								<form id="theForm" method="post" class="form-horizontal" enctype="multipart/form-data">        
									<input type="hidden" id="colorSid_" name="sid"/>
									<div class="form-group">
										<label class="col-lg-3 control-label">包装名称</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" id="colorName_" name="colorName" placeholder="必填"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="colorAlias_" name="colorAlias" placeholder="必填"/>
										</div>
									</div>
