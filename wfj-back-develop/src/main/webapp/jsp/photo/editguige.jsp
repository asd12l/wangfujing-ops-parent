  		...
  		$('#theForm').bootstrapValidator({
			...
			submitHandler : function(validator, form, submitButton) {
				...
				$.ajax({
					...
					url: __ctxPath + "/photo/updatePhotoguige",
					data: $("#theForm").serialize(),
					success: function(response) {
						if(response.success==true){
							$("#warning2Body").text("图片规格修改成功!");
							//$("#modal-body-success").html("<div class='alert alert-success fade in'><strong>图片规格修改成功!</strong></div>");
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<div class="widget radius-bordered">
							<div class="widget-header">
								<span class="widget-caption">修改图片规格</span>
							</div>
							<div class="widget-body">
								<form id="theForm" method="post" class="form-horizontal">
									<div>
										<input type="hidden" id="sid" name="photo_id"/> 			
									</div>
									<div class="form-group">
										<div class="col-lg-8 col-sm-8 col-xs-8 col-lg-offset-2">
											...
											<div class="col-lg-6 col-sm-6 col-xs-6">
												...
												<input maxlength="20" type="text" class="form-control" id="width" name="width" readOnly="true" onpaste="return false;"/>
									...
									<div class="form-group">
										<div class="col-lg-8 col-sm-8 col-xs-8 col-lg-offset-2">
											...
											<div class="col-lg-6 col-sm-6 col-xs-6">
												...
												<input maxlength="20" type="text" class="form-control" id="height" name="height" readOnly="true" />
