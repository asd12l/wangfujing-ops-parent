	...
	$(function(){
  	...
  	function saveFrom(){
  		...
  		$.ajax({
 	        ...
 	        url:__ctxPath + "/back/sortRuleUpdate",
 	        dataType: "json",
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<div class="widget radius-bordered">
							<div class="widget-header">
								<span class="widget-caption">修改排序规则</span>
							</div>
							<div class="widget-body">
								<form id="theForm" method="post" class="form-horizontal">   
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="showText" value=<%=java.net.URLDecoder.decode((String)request.getParameter("showText"), "UTF-8")%> name="showText"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-3 control-label">显示顺序</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" id="showOrder" name="showOrder" value="${param.showOrder}"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-3 control-label">默认排序规则</label>
										<div class="col-lg-6">
											<select id="defaultOrderBy" name="defaultOrderBy">
													<option selected="selected" value="${param.defaultOrderBy}">${param.defaultOrderBy eq "asc"?"升序":"降序"}</option>
													<option value='${param.defaultOrderBy eq "asc"?"desc":"asc"}'>${param.defaultOrderBy eq "asc"?"降序":"升序"}</option>
											</select>
										</div>
									</div>
         							<div class="form-group">
