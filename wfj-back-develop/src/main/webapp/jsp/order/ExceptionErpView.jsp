...
/* 	saleMsgImage="http://172.16.200.4/images"; */
	...
	function olvQuery(){
		...
		LA.log('exceptionErp-search', '销售单线上查询', userName,  sessionId);
	...
	//初始化包装单位列表
 	function initOlv() {
		var url = __ctxPath+"/omsOrder/selectPushErpException";
...
//		$("#btDiv").show();
		...
		if(dealFlag !='1'){
			...
			$.ajax({
				...
				url:__ctxPath + "/omsOrder/saleSendOffLineErp",
				async:false,
				dataType: "json",
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption"><h5>异常销售单管理(线上)</h5></span>
