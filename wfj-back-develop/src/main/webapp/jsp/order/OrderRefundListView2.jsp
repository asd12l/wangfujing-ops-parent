...
function reloadjs(){
	...
	function olvQuery(){
		...
		LA.log('order2Return-search', '退货单查询2', userName,  sessionId);
	...
	var refundNo1;
	function cancelButten(refundNo,obj){
		$("#btDivCancel").show();
	...
	function Ok1(){
		...
		$.ajax({
			type : "post",
			contentType : "application/x-www-form-urlencoded;charset=utf-8",
			url : __ctxPath + "/omsOrder/refundCancel",
			async : false,
			data : {
				"refundNo" : refundNo1,
	...
	function fundButten(paymentAmountSum,quanAmount,refundAmount,refundApplyNo,courierNumber,expressCompanyName,refundStatus,orderNo,refundNo,returnShippingFee,address,returnType,obj){
		...
		//物流信息
		expressCompanyName_=expressCompanyName;
		courierNumber_=courierNumber;
		address_=address;
		/* //查询订单明细
		$.ajax({
			type : "post",
...
//				rowNo_ = data_.billDetail.sellPayments.length;
				/* var url = __ctxPath + "/jsp/order/RefundView3.jsp";
				$("#pageBody").load(url); */
				return;
			}
		}); 
	...
	//初始化包装单位列表
 	function initOlv() {
		var url = __ctxPath+"/testOnlineOmsOrder/selectRefundList2";
		...
		$.ajax({
			...
			success:function(response) {
				if(response.success=='true'){
					...
					for(var i=0;i<result.length;i++){
						var ele = result[i];
						option2+="<tr id='gradeY31"+ele.packageNo+"' style='height:35px;overflow-X:hidden;'>"+
						"<td align='center' style='vertical-align:middle;'>"+
						"<span id='spanTd31_"+ele.packageNo+"' onclick='spanTd31(\""+ele.packageNo+"\")' "+
						"class='expand-collapse click-expand glyphicon glyphicon-plus' style='cursor:pointer;'></span></td>";
						//订单号
						if(ele.orderNo=="[object Object]"||ele.orderNo==undefined){
...
//							option3+="<td align='center'>"+ele.deleteFlag+"</td>";
		...
		$("#OLV32_tab").html(option2);
		$("#OLV33_tab").html(option3);
		$("#OLV34_tab").html(option4);
		$("#OLV35_tab").html(option5);
		$("#OLV36_tab").html(option6);
		$("#divTitle31").html("订单详情");
		$("#btDiv31").show();
	}
	...
	//包裹单明细
 	function spanTd31(obj) {
		if ($("#spanTd31_"+obj).attr("class") == "expand-collapse click-expand glyphicon glyphicon-plus") {
			$("#spanTd31_"+obj).attr("class","expand-collapse click-collapse glyphicon glyphicon-minus");
			$.ajax({
				type : "post",
				contentType : "application/x-www-form-urlencoded;charset=utf-8",
			...
			$("#spanTd31_" + obj).attr("class","expand-collapse click-expand glyphicon glyphicon-plus");
			$("#afterTr31" + obj).remove();
		}
...
//		 var newTr =  newTr1.parent().parent().clone(true);
			...
			success:function(response) {
				if(response.success=='true'){
					...
					for(var i=0;i<result.length;i++){
						...
						"<td align='center' style='vertical-align:middle;'>"+
						"<span id='spanTd_"+ele.salesItemNo+"' onclick='spanTd41(\""+ele.salesItemNo+"\")' "+
						"class='expand-collapse click-expand glyphicon glyphicon-plus' style='cursor:pointer;'></span></td>";
						//行号
						if(ele.rowNo=="[object Object]"||ele.rowNo==undefined){
							option+="<td align='center'></td>";
		...
		$("#OLV41_tab").html(option);
		$("#OLV42_tab").html(option2);
		$("#OLV43_tab").html(option3);
		$("#OLV44_tab").html(option4);
		$("#divTitle4").html("销售单详情");
		$("#btDiv4").show();
	}
	function closeBtDiv4(){
		$("#btDiv4").hide();
	}
	//销售单明细促销
 	function spanTd41(obj) {
		if ($("#spanTd_"+obj).attr("class") == "expand-collapse click-expand glyphicon glyphicon-plus") {
			$("#spanTd_"+obj).attr("class","expand-collapse click-collapse glyphicon glyphicon-minus");
			$.ajax({
				type : "post",
...
<body>
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <h5 class="widget-caption">退货单信息管理</h5>
                                ...
                                <div class="widget-body" id="pro">
                                    	...
                                    	<ul class="topList clearfix">
											    ...
											    <li class="col-md-4">
													...
													<select id="refundStatus_select" style="padding:0 0;">
                                                        ...
                                                        <option value="1">待寄回</option>
                                                        <option value="2">入集货</option>
                                                        <option value="3">分拣复合</option>
                                                        <option value="4">出集货</option>
                                    ...
                                    <table class="table-striped table-hover table-bordered" id="olv_tab" style="width: 120%;background-color: #fff;margin-bottom: 0;">
                                        <thead>
                                            <tr role="row" style='height:35px;'>
                                                ...
                                                <th width="6%" style="text-align: center;">最后修改时间</th>
                                                ...
                                                <th width="5%" style="text-align: center;">第三方退货单号</th>
                                                <th width="3%" style="text-align: center;">应退金额</th>
                                                <th width="3%" style="text-align: center;">实退金额</th>
        ...
        <div class="modal-dialog" style="width: 800px;height:80%;margin: 3% auto;">
            <div class="modal-content">
               ...
               <div class="page-body" id="pageBodyRight">
                ...
                <div class="tabbable"> <!-- Only required for left/right tabs -->
					      <ul class="nav nav-tabs">
					        <li class="active"><a href="#tab21" data-toggle="tab">退货单商品明细</a></li>
					        <li><a href="#tab22" data-toggle="tab">退款信息</a></li>
							<li><a href="#tab23" data-toggle="tab">历史信息</a></li>
					      </ul>
					      <div class="tab-content">
					        <div class="tab-pane active" id="tab21">
					                <div style="width:100%;height:200px; overflow:scroll;">
					                    <table class="table-striped table-hover table-bordered" id="OLV21_tab" style="width: 700%;height:35px;background-color: #fff;margin-bottom: 0;">
					                    </table>
					                </div>
					        </div>
					        <div class="tab-pane" id="tab22">
					          <div style="width:100%;height:200px; overflow:scroll;">
					                    <table class="table-striped table-hover table-bordered" id="OLV22_tab" style="width: 400%;height:35px;background-color: #fff;margin-bottom: 0;">
					                    </table>
					                </div>
					        </div>
					         <div class="tab-pane" id="tab23">
					         	<div style="width:100%;height:200px;overflow:scroll; ">
					                    <table class="table-striped table-hover table-bordered" id="OLV23_tab" style="width: 150%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					                </div>
					         </div>
					      </div>
    ...
    <div class="modal modal-darkorange" id="btDiv4">
        <div class="modal-dialog" style="width: 800px;height:80%;margin: 3% auto;">
            <div class="modal-content">
                <div class="modal-header">
                    <button aria-hidden="true" data-dismiss="modal" class="close" type="button" onclick="closeBtDiv4();">×</button>
                ...
                <div class="page-body" id="pageBodyRight">
                    ...
                    <div class="tabbable"> <!-- Only required for left/right tabs -->
					      <ul class="nav nav-tabs">
					        <li class="active"><a href="#tab41" data-toggle="tab">销售单商品明细</a></li>
					        <li><a href="#tab42" data-toggle="tab">支付信息</a></li>
							<li><a href="#tab43" data-toggle="tab">发票信息</a></li>
							<li><a href="#tab44" data-toggle="tab">历史信息</a></li>
					      </ul>
					      <div class="tab-content">
					        <div class="tab-pane active" id="tab41">
					            <div style="width:100%;height:200px; overflow:scroll;">
					                    <table class="table-striped table-hover table-bordered" id="OLV41_tab" style="width: 600%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					              </div>
					        </div>
					        <div class="tab-pane" id="tab42">
					          <div style="width:100%;height:200px; overflow:scroll;">
					                    <table class="table-striped table-hover table-bordered" id="OLV42_tab" style="width: 650%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					                </div>
					        </div>
					        <div class="tab-pane" id="tab43">
					        	<div style="width:100%;height:200px; ">
					                    <table class="table-striped table-hover table-bordered" id="OLV43_tab" style="width: 100%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					                </div>
					         </div>
					         <div class="tab-pane" id="tab44">
					         	<div style="width:100%;height:200px;overflow:scroll; ">
					                    <table class="table-striped table-hover table-bordered" id="OLV44_tab" style="width: 150%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					                </div>
					         </div>
					      </div>
                ...
                <div class="modal-footer">
                    <button data-dismiss="modal" class="btn btn-default" onclick="closeBtDiv4();" type="button">关闭</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div> 
    ...
    <div class="modal modal-darkorange" id="btDiv31">
        <div class="modal-dialog" style="width: 800px;height:80%;margin: 3% auto;">
            <div class="modal-content">
                ...
                <div class="page-body" id="pageBodyRight3">
                    <div class="row">
                        <div  class="col-xs-12 col-md-12" style="overflow-Y: hidden;">
			               <table class="table-striped table-hover table-bordered" style="width: 200%;background-color: #fff;margin-bottom: 0;">
                                        <thead>
                    ...
                    <div class="tabbable"> <!-- Only required for left/right tabs -->
					      <ul class="nav nav-tabs">
					        <li class="active"><a href="#tab31" data-toggle="tab">订单明细</a></li>
					        <li><a href="#tab33" data-toggle="tab">支付信息</a></li>
					        <li><a href="#tab32" data-toggle="tab">包裹信息</a></li>
							<li><a href="#tab34" data-toggle="tab">历史信息</a></li>
							<li><a href="#tab35" data-toggle="tab">销售单信息</a></li>
							<li><a href="#tab36" data-toggle="tab">发票信息</a></li>
					      </ul>
					      <div class="tab-content">
					        <div class="tab-pane active" id="tab31">
					            <div style="width:100%;height:200px; overflow:scroll;">
					                    <table class="table-striped table-hover table-bordered" id="OLV31_tab" style="width: 750%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					              </div>
					        </div>
					        <div class="tab-pane" id="tab33">
					          <div style="width:100%;height:200px; overflow:scroll;">
					                    <table class="table-striped table-hover table-bordered" id="OLV33_tab" style="width: 250%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					                </div>
					        </div>
					        <div class="tab-pane" id="tab32">
					          <div style="width:100%;height:200px; overflow:scroll;">
					                    <table class="table-striped table-hover table-bordered" id="OLV32_tab" style="width: 250%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					                </div>
					        </div>
					         <div class="tab-pane" id="tab34">
					         	<div style="width:100%;height:200px;overflow:scroll; ">
					                    <table class="table-striped table-hover table-bordered" id="OLV34_tab" style="width: 150%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					                </div>
					         </div>
					          <div class="tab-pane" id="tab35">
					          	<div style="width:100%;height:200px; overflow:scroll;">
					                    <table class="table-striped table-hover table-bordered" id="OLV35_tab" style="width: 450%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					             </div>
					        </div>
					          <div class="tab-pane" id="tab36">
					          	<div style="width:100%;height:200px; overflow:scroll;">
					                    <table class="table-striped table-hover table-bordered" id="OLV36_tab" style="width: 150%;background-color: #fff;margin-bottom: 0;">
					                    </table>
					             </div>
					        </div>
					       <!--  &nbsp;
