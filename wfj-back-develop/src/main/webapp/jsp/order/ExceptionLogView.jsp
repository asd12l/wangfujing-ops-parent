...
function reloadjs(){
	...
	function olvQuery(){
		...
		LA.log('exceptionLog-search', '异常总信息查询', userName,  sessionId);
	...
	//初始化包装单位列表
 	function initOlv() {
		var url = __ctxPath+"/oms/selectExceptionLog";
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption"><h5>异常总信息管理</h5></span>
                                    	...
                                    	<ul class="topList clearfix">
										    <li class="col-md-4">
										        ...
										        <li class="col-md-4">
													...
													<input type="text" id="exceptionType_input"/>
										    </li>
										    <li class="col-md-4">
                               			...
                               			<form id="olv_form" action="">
											...
											<input type="hidden" id="exceptionType_from" name="exceptionType"/>
                                    ...
                                    <table class="table-striped table-hover table-bordered" id="olv_tab" style="width: 150%;background-color: #fff;margin-bottom: 0;">
                                        <thead>
                                            <tr role="row" style="height:35px;">
                                                <th width="10%" style="text-align: center;">单据号</th>
                                                <th width="10%" style="text-align: center;">异常类型</th>
                                                <th width="10%" style="text-align: center;">异常接口</th>
                                                <th width="10%" style="text-align: center;">参数</th>
                                                <th width="50%" style="text-align: center;">返回异常信息</th>
                                                <th width="10%" style="text-align: center;">异常出现时间</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
										...
										{#template MAIN}
											{#foreach $T.list as Result}
												<tr class="gradeX" id="gradeX{$T.Result.sid}" style="height:35px;" >
													...
													<td align="center" id="spn_{$T.Result.sid}" onclick="trClick({$T.Result.sid},this)"><span  class='btn btn-danger btn-xs'>请点击</span></td>
