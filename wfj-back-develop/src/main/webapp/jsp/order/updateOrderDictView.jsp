		...
		$('#theForm').bootstrapValidator({
			...
			submitHandler : function(validator, form, submitButton) {
				...
				$.ajax({
					...
					url : __ctxPath + "/omsOrder/updateCodeList",
								...
								<form id="theForm" method="post" class="form-horizontal">   
									...
									<div class="form-group">
										<div class="col-lg-8 col-sm-8 col-xs-8 col-lg-offset-2">
											...
											<div class="col-lg-6" style="width:230px;">
												<input type="text" class="form-control" id="code" name="codeValue" readonly="readonly" placeholder="必填"/>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-lg-8 col-sm-8 col-xs-8 col-lg-offset-2">
											...
											<div class="col-lg-6" style="width:230px;">
												<input type="text" class="form-control" id="name" name="codeName" placeholder="必填" onpaste="return false"/>
											</div>
										</div>
									</div>
        							<!-- <div class="form-group">
