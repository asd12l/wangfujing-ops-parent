...
//							option3+="<td align='center'>"+ele.deleteFlag+"</td>";
	...
	function successBtn(){
		...
		$("#pageBody").load(__ctxPath+"/jsp/order/CodOrderView.jsp");
	}
	</script> 
</head>
<body>
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <h5 class="widget-caption">COD订单管理</h5>
                                ...
                                <div class="widget-body" id="pro">
                                    <div class="table-toolbar">
                               			...
                               			<form id="olv_form" action="">
											...
											<input type="hidden" id="isCod" name="isCod" value="1"/>
											...
											{#foreach $T.list as Result}
												<tr class="gradeX" id="gradeX{$T.Result.sid}" style="height:35px;">
													...
													<td align="center" id="orderSource_{$T.Result.sid}">
						                   				...
						                   				{#if $T.Result.orderSource == 'C1'}线上 C1
															{#elseif $T.Result.orderSource == 'X1'}
																<span>线下 X1</span>
															{#elseif $T.Result.orderSource == 'CB'}
																<span>全球购</span>
															{#elseif $T.Result.orderSource == 'C7'}
																<span>天猫</span>
														{#/if}
													</td>
													<td align="center" id="orderType_{$T.Result.sid}">
														{#if $T.Result.orderType == 'PT'}普通订单
						                      			{#elseif $T.Result.orderType == 'TG'}
						                      				<span>团购订单</span>
						                      			{#elseif $T.Result.orderType == 'DK'}
						                      				<span>代客下单</span>
						                      			{#elseif $T.Result.orderType == 'KT'}
						                      				<span>快腿订单</span>
						                      			{#elseif $T.Result.orderType == 'YG'}
						                      				<span>员工订单</span>
						                   				{#/if}
													</td>
													...
													<td align="center" id="paymentClass_{$T.Result.sid}">
						                   				{#if $T.Result.paymentClass == 'ONLINE'}
															<span>在线支付</span>
						                      			{#else}
						                      				<span>货到付款</span>
						                   				{#/if}
													...
													<td align="center" id="cashIncome_{$T.Result.sid}">
														{#if $T.Result.cashIncome != '[object Object]'}{$T.Result.cashIncome}
						                   				{#/if}
													</td>
                ...
                <div class="page-body" id="pageBodyRight">
                    <div class="row">
                        <div  class="col-xs-12 col-md-12" style="overflow-Y: hidden;">
			               <table class="table-striped table-hover table-bordered" style="width: 800%;background-color: #fff;margin-bottom: 0;">
                                        <thead>
                                            <tr role="row" style='height:35px;'>
                                                <th width="3%" style="text-align: center;">订单号</th>
                                                <th width="3%" style="text-align: center;">外部订单号</th>
