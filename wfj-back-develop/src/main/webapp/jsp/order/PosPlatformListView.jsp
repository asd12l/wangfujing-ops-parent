...
/* 	saleMsgImage="http://172.16.200.4/images"; */
	...
	function olvQuery(){
		$("#businessClass_form").val($("#businessClass_select").val());
	...
	//初始化包装单位列表
 	function initOlv() {
		var url = __ctxPath+"/omsOrder/posPlatFormList";
...
//							option3+="<td align='center'>"+ele.deleteFlag+"</td>";
	...
	function exportExecel() {
		...
		var title = "PosPlatform";
		var count = $("#olv_tab tbody tr").length;
		
		if (count > 0
				/* && (orderNo != "" || paymentType != "" || startTime != "" || endTime != "") */) {
			window.open(__ctxPath + "/omsOrder/getPosPlatformToExcel?paymentType=" + paymentType + "&&startTime=" + startTime + "&&endTime=" + endTime
					 + "&&orderNo=" + orderNo + "&&title=" + title);
		} else {
			$("#model-body-warning")
					.html(
	...
	function successBtn(){
		...
		$("#pageBody").load(__ctxPath+"/jsp/order/PosPlatformListView.jsp");
	}
	</script> 
</head>
<body>
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <h5 class="widget-caption">支付平台报表明細</h5>
                                ...
                                <div class="widget-body" id="pro">
                                    <div class="table-toolbar">
                                    		<ul class="topList clearfix">                           			
                                    			...
                                    			<li class="col-md-4">
	                                    				...
	                                    				<select id="businessClass_select" style="padding:0 0;">
									...
									<form id="olv_form" action="">
										...
										<input type="hidden" id="orderNo_form" name="orderNo"/>
                           				<input type="hidden" id="businessClass_form" name="businessClass"/>
										...
										{#template MAIN}
											{#foreach $T.list as Result}
												<tr class="gradeX" id="gradeX{$T.Result.sid}" style="height:35px;">
													<td align="center">
														<a onclick="trClick('{$T.Result.orderNo}','{$T.Result.isCod}',this);" style="cursor:pointer;">
