		...
		$.ajax({
				...
				success : function(response) {
					if(response.success=='true'){
						...
						$("#model-body-warning").html("<div class='alert alert-warning fade in'><i class='fa-fw fa fa-times'></i><strong>"+"创建退货申请单失败"+"</strong></div>");
						...
						for(var i=0;i<result.length;i++){
							...
							//操作
							 if(i==0){
								...
								'<input class="btn btn-success" style="width: 60%;height: 30px;" id="refundButten" onclick="refundButten('+"'"+ele.saleNo+"',"+"'"+ele.orderNo+"'"+',this)" type="button" value="退货申请" />'+
								"</td>"; 
							 }
							option+="</tr>";
						}
		...
		$.ajax({
			...
			success : function(response) {
				if(response.success=='true'){
					...
					var url = __ctxPath + "/jsp/order/ExceptionRefundView4.jsp";
					$("#pageBody").load(url);
				}else{
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <h5 class="widget-caption">地址异常订单管理</h5>
