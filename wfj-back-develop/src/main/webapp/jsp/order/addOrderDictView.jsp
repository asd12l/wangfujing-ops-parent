		...
		$('#theForm').bootstrapValidator({
			...
			submitHandler : function(validator, form, submitButton) {
				...
				$.ajax({
					...
					url : __ctxPath + "/omsOrder/saveCodeList",
	...
	function ClassifyTwo(){
		...
		$.ajax({
			...
			success : function(response) {
				...
				var pid_select2 = $("#pid_select").val();
				for (var i = 0; i < result2.length; i++) {
					var ele2 = result2[i];
					if(ele2.typeValue==pid_select2){
						$("#typeName_select2").val(ele2.typeName);
					}
				}
								...
								<form id="theForm" method="post" class="form-horizontal"
									...
									<div class="form-group">
										<div class="col-lg-8 col-sm-8 col-xs-8 col-lg-offset-2">
											...
											<div class="col-lg-6 col-sm-6 col-xs-6" style="width:230px;">
												<select class="form-control" id="pid_select" name="typeValue"></select>
											</div>											
										</div>
									</div>
									<div class="form-group">
										<div class="col-lg-8 col-sm-8 col-xs-8 col-lg-offset-2">
											...
											<div class="col-lg-6 col-sm-6 col-xs-6" style="width:230px;">
												<input type="text" class="form-control" id="code" name="codeValue"
									...
									<div class="form-group">
										<div class="col-lg-8 col-sm-8 col-xs-8 col-lg-offset-2">
											...
											<div class="col-lg-6 col-sm-6 col-xs-6" style="width:230px;">
												<input type="text" class="form-control" id="name" name="codeName"
												placeholder="必填" onpaste="return false" />
											</div>											
										</div>
									</div>
