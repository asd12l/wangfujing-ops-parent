...
function reloadjs(){
	...
	function olvQuery(){
		...
		LA.log('exception-search', '异常订单查询', userName,  sessionId);
	...
	//初始化包装单位列表
 	function initOlv() {
		var url = __ctxPath+"/omsOrder/selectExceptionOrder";
...
//		$("#btDiv").show();
		...
		if(dealFlag !='1'){
			...
			$.ajax({
				...
				url:__ctxPath + "/omsOrder/orderSendErp",
				async:false,
				dataType: "json",
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption"><h5>异常订单管理</h5></span>
