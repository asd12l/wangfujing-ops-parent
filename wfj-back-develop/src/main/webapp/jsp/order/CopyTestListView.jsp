...
/* 	saleMsgImage="http://172.16.200.4/images"; */
	...
	function foundSale1(){
		...
		var url = __ctxPath + "/copyTestOms/foundSale";
  		$.ajax({
			type: "post",
	...
	function printSale1(){
		...
		var url = __ctxPath + "/copyTestOms/printSale";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function salePos1(){
		...
		var url = __ctxPath + "/copyTestOms/salePos";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function salePay1(){
		...
		$("#sale_pos").html("输入参数："+saleData);
		var url = __ctxPath + "/copyTestOms/salePay";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function saveInvoice1(){
		...
		$("#sale_pos").html("输入参数："+saleData);
		var url = __ctxPath + "/copyTestOms/saveInvoice";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function invoiceCancel1(){
		...
		$("#sale_pos").html("输入参数："+saleData);
		var url = __ctxPath + "/copyTestOms/invoiceCancel";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function salePadCreat1(){
		...
		var url = __ctxPath + "/copyTestOms/salePadCreat";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function salePadCancel1(){
		...
		$("#sale_pad").html("输入参数："+saleData);
		var url = __ctxPath + "/copyTestOms/salePadCancel";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function salePadAdd1(){
		...
		$("#sale_pad").html("输入参数："+saleData);
		var url = __ctxPath + "/copyTestOms/salePadAdd";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function salePadCancle1(){
		...
		$("#sale_pad").html("输入参数："+saleData);
		var url = __ctxPath + "/copyTestOms/salePadCancle";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function salePad1(){
		...
		$("#sale_pad").html("输入参数："+saleData);
		var url = __ctxPath + "/copyTestOms/salePad";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function printPay1(){
		...
		var url = __ctxPath + "/copyTestOms/printPay";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function saleCancel1(){
		...
		var url = __ctxPath + "/copyTestOms/saleCancel";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function refundCancel1(){
		...
		$("#bills_cancel").html("输入参数："+saleData);
		var url = __ctxPath + "/copyTestOms/refundCancel";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function takeStock1(){
		...
		var url = __ctxPath + "/copyTestOms/takeStock";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function foundRefund1(){
		...
		var url = __ctxPath + "/copyTestOms/foundRefund";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function printRefund1(){
		...
		var url = __ctxPath + "/copyTestOms/printRefund";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function examineRefund1(){
		...
		var url = __ctxPath + "/copyTestOms/examineRefund";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function refundPos1(){
		...
		var url = __ctxPath + "/copyTestOms/refundPos";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function returnStock1(){
		...
		var url = __ctxPath + "/copyTestOms/returnStock";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function foundExchange1(){
		...
		var url = __ctxPath + "/copyTestOms/foundExchange";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function updateExchange1(){
		...
		$("#exchange").html("输入参数："+saleData);
		var url = __ctxPath + "/copyTestOms/updateExchange";
  		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function getExchange(obj){
		...
		var url = __ctxPath + "/copyTestOms/getExchange";
		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
	...
	function getProduct(obj){
		...
		var url = __ctxPath + "/copyTestOms/selectProduct";
		$.ajax({
			type: "post",
			contentType: "application/x-www-form-urlencoded;charset=utf-8",
			dataType:"json",
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption"><h5>测试(第二套方案)</h5></span>
													...
													<table style="width: 50px;">
														...
														<tbody>
														  <tr>
															...
															<td align="center" onclick="copyTr(this)" style="vertical-align:middle;"><span class="expand-collapse click-expand glyphicon glyphicon-plus"></span></td>
														  </tr>
														</tbody>
													</table>&nbsp;
												</div>
                                        ...
                                        <div class="tab-content">
                                            <div id="home" class="tab-pane in active" style="height:400px;overflow:scroll;">
                                            	 ...
                                            	 <div class="col-md-4">
							                        ...
							                        <div class="col-md-7">
							                          <input type="text" class="form-control" onchange="changeAmoun(this)" id="actualPaymentAmountp" name="actualPaymentAmount"  />
							                        </div>
							                        &nbsp; </div>
							                         <div class="col-md-4">
							                        ...
							                        <tbody>
							                          <tr>
							                            ...
							                            <td align="center" onclick="copyTr(this)" style="vertical-align:middle;">
															<span class="expand-collapse click-expand glyphicon glyphicon-plus"></span>
															</td>
							                          </tr>
							                        </tbody>
							                      </table>&nbsp;
                                            ...
                                            <div id="home" class="tab-pane in active">
												...
												<div class="col-md-12">
													<table>
														...
														<tbody>
														  <tr>
															<td><input name="refundNum" value="1"></input></td>
															<td><input name="saleItemNo" value="******-1"></input></td>
															<td align="center" onclick="copyTr(this)" style="vertical-align:middle;">
															<span class="expand-collapse click-expand glyphicon glyphicon-plus"></span>
															</td>
														  </tr>
