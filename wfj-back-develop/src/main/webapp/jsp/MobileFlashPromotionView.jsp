...
<script type="text/javascript" src="${ctx}/sysjs/mobilepromotion/addmobileflashpromotion.js"></script>
<script type="text/javascript" src="${ctx}/sysjs/mobilepromotion/mobileflashpromotion.js"></script>
<script type="text/javascript" src="${ctx}/sysjs/mobilepromotion/updatemobileflashpromotion.js"></script>
<script type="text/javascript" src="${ctx}/sysjs/mobilepromotion/addmobileflashproduct.js"></script>
<script type="text/javascript" src="${ctx}/sysjs/mobilepromotion/mobileflashmanagepage.js"></script>
