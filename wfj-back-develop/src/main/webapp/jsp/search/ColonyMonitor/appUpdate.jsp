...
<script type="text/javascript">
	...
	$(function(){
  	...
  	//保存数据
  	function saveFrom(){
  		var appsid = $("#sid").attr("value");
  		var value=	$("#appName").attr("value");
  		$.ajax({
  			 type:"post",
 	        contentType: "application/x-www-form-urlencoded;charset=utf-8",
 	        url:__ctxPath + "/back/monitorUpdate",
 	        dataType: "json",
							...
							<div class="widget-body">
								<form id="theForm" method="post" class="form-horizontal">   
									...
									<div class="form-group">
										<label class="col-lg-3 control-label">程序名</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" id="appName" value="${param.appName }" name="appName" />
										</div>
									</div>
