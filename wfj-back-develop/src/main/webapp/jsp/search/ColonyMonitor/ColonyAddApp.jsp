...
<script type="text/javascript">
	...
	$(function(){
  	...
  	//保存数据
  	function saveFrom(){
  		var value=	$("#appName").attr("value");
  		$.ajax({
	        type:"post",
	        contentType: "application/x-www-form-urlencoded;charset=utf-8",
	        url:__ctxPath + "/back/monitorSave",
	        dataType: "json",
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<div class="widget radius-bordered">
							<div class="widget-header">
								<span class="widget-caption">新增App</span>
							</div>
							<div class="widget-body">
								<form id="theForm" method="post" class="form-horizontal" enctype="multipart/form-data">        
									<div class="form-group">
										<label class="col-lg-3 control-label">appName</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" id="appName" name="appName" placeholder="必填"/>
										</div>
									</div>
         							<div class="form-group">
