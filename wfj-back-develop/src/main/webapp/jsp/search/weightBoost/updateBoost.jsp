...
//			        	    $("#warning2Body").text(response.msg);
  		...
  		$("#close").click(function(){
  			$("#pageBody").load(__ctxPath+"/jsp/search/weightBoost/addBoost.jsp");
  		});
	}); 
  	function successBtn(){
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<div class="widget radius-bordered">
							<div class="widget-header">
								<span class="widget-caption">修改加权</span>
							</div>
							<div class="widget-body">
								<form id="theForm" method="post" class="form-horizontal" enctype="multipart/form-data">  
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="skuId" name="skuId" value="${param.skuId }" placeholder="必填"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="boost" name="boost" value="${param.boost }" placeholder="必填"/>
										</div>
									</div>
