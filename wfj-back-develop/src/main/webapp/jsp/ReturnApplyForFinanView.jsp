					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<span class="widget-caption"><h5>财务退货申请单管理</h5> </span>
							...
							<div class="widget-body" id="pro">
								<div class="table-toolbar">
									...
									<div class="col-md-4">
										...
										<div class="col-lg-7">
											<select id="refundGoodDesc_select" style="padding: 0 0; width: 100%">
												<option value="">所有</option>
									...
									<div class="col-md-4">
										<div class="col-lg-12">
											<a class="btn btn-default" onclick="olvQuery1();">查询</a> <a
												class="btn btn-default" onclick="reset1();">重置</a>
										</div>
										&nbsp;
									</div>
									<div class="col-md-4">
									...
									<table class="table-striped table-hover table-bordered"
										...
										<thead>
											<tr role="row">
												...
												<th width="7%" style="text-align: center;">退货申请单号</th>
												<th width="7%" style="text-align: center;">订单号</th>
												<th width="4%" style="text-align: center;">退货申请单状态</th>
												...
												<th width="4%" style="text-align: center;">物流确认收货时间</th>
