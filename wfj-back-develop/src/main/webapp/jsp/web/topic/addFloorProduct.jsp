...
<!-- 商品列表弹窗 -->
<div class="modal modal-darkorange" id="addProductDIV" style="top:-15px;">
				...
				<div class="row">
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							...
							<div class="widget-body" id="pro" style="height: 560px; overflow: auto;">
									...
									<div class="mtb10">
										<table>
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<a class="btn btn-default" onclick="productQuery();">查询</a></td>
										...
										{#template MAIN}
											{#foreach $T.list as Result}
												<tr class="gradeX">
													...
													<td align="center">
														<a onclick="getView({$T.Result.sid});" style="cursor:pointer;" id="proSkuCode_{$T.Result.sid}">{$T.Result.skuCode}</a></td>
													<td align="center">
														<a onclick="getView({$T.Result.sid});" style="cursor:pointer;" id="name_{$T.Result.sid}">{$T.Result.skuName}</a></td>
