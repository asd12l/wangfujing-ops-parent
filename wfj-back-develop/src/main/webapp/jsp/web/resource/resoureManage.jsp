				...
				{#template MAIN}
					{#foreach $T.list as Result}
						<tr class="gradeX">
							...
							<input type='hidden' id='hasContent_{$T.Result.name}' value='{$T.Result.hasContent}'></input>
							<td align="center">
							...
							<td onhover="" align="center" id="name_{$T.Result.name}"><label>{$T.Result.name}</label></td>
