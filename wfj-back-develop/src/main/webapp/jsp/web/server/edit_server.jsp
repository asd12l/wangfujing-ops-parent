...
<script	src="${pageContext.request.contextPath}/js/customize/server/editServer.js"></script>
</head>
<body>
	<div class="page-body">
		<div class="row">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<div class="widget radius-bordered">
							<div class="widget-header">
								<span class="widget-caption">修改webServer</span>
							</div>
							<div class="widget-body">
								<form id="theForm" method="post" class="form-horizontal"
									enctype="multipart/form-data">
									<input type="hidden" name="id" id="server_id" value="" />
