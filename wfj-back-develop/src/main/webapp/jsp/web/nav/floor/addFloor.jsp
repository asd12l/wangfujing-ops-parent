<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="modal modal-darkorange" id="addFloor" style="top:-70px;">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="bootbox-body">
					<div class="row" style="padding: 10px;">
						<div class="col-md-12">
							<form id="floorForm" method="post" class="form-horizontal" >
								<input type="hidden" id="add_channel_sid" name="channelSid" value=""/>
								...
								<div class="form-group">
		                            ...
		                            <div class="col-sm-9">
										<input type="text" class="form-control clear_input" id="title_add" name="title" >
		                            </div>
		                        </div>
								<div class="form-group">
		                            <label class="col-sm-3 control-label">英文名称：</label>
		                            <div class="col-sm-9">
										<input type="text" class="form-control clear_input" id="en_title_add" name="enTitle" >
		                            </div>
		                        </div>
								<div class="form-group">
		                            <label class="col-sm-3 control-label">频道链接：</label>
		                            <div class="col-sm-9">
										<input type="text" class="form-control clear_input" id="channel_link_add" name="channelLink" >
		                            </div>
		                        </div>
								<div class="form-group">
		                            <label class="col-sm-3 control-label">
		                            ...
		                            <div class="col-sm-9">
		                            	<div class="spinner spinner-horizontal spinner-two-sided">
                                            ...
                                            <input type="text" class="spinner-input form-control clear_input" id="floor_seq_add" name="seq"/>
			...
			<div class="modal-footer">
				<button class="btn btn-default" type="button"
					onclick="saveFloorFrom();">保存</button>
