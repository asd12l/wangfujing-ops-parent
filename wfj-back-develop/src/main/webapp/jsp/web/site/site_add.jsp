...
<script	src="${pageContext.request.contextPath}/js/customize/site/addSite.js"></script>
</head>
<body>
	<div class="page-body">
		<div class="row">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<div class="widget radius-bordered">
							<div class="widget-header">
								<span class="widget-caption">添加站点</span>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											...
											<input type="text" class="form-control" id="site_path_"
												name="sitePath" placeholder="" readonly="true"/>
											</div>
										</div>
									</div>
									<div class="form-group">
