 ...
 color:red;
  ...
  <script type="text/javascript">
	...
	function query() {
    	...
    	LA.sysCode = '64';
		LA.log('memberLoginActive-query', '会员活跃度查询', userName,  sessionId);
		$("#cache").val(0);
		productQuery();
	}
	//重置
	function reset(){
		userName = getCookieValue("username");
    	LA.sysCode = '64';
		LA.log('memberLoginActive-reset', '会员活跃度重置查询', userName,  sessionId);
		$("#cache").val(1);
		$("#username").val("");
		//$("#reservation").val("");
		productQuery();
	...
	//初始化包装单位列表
 	function initOlv() {
		...
		var url = __ctxPath+"/memLogin/getMemberActive";
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <h5 class="widget-caption">会员用户活跃度</h5>
