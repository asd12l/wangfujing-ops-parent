...
.trClick>td,.trClick>th{
 color:red;
  ...
  <script type="text/javascript">
	...
	//初始化包装单位列表
 	function initOlv() {
		var url = __ctxPath+"/memberAccount/getByMemberCoupon";
	...
	function successBtn(){
		...
		$("#pageBody").load(__ctxPath+"/jsp/mem/MemberCouponView.jsp");
	}
</script>
<!-- 加载样式 -->
<script type="text/javascript">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body" id="pro">
                                    <div class="table-toolbar">
                                    		<div class="mtb10">
                                    		<span class="titname">优惠券时间：</span> <input type="text" id="reservation" />
                                   ...
                                   <table class="table table-bordered table-striped table-condensed table-hover flip-content"
									id="olv_tab" style="width: 200%;background-color: #fff;margin-bottom: 0;">
                                        <thead>
											...
											<th style="text-align: center;" width="10%">优惠券时间</th>
											<th style="text-align: center;" width="10%">优惠券名称</th>
											<th style="text-align: center;" width="10%"> 优惠券类别</th>
											<th style="text-align: center;" width="10%">详细说明</th>
											<th style="text-align: center;" width="8%">使用状态</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
