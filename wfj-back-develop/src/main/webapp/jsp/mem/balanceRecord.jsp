                                ...
                                <div class="table-toolbar">
                                		<ul class="topList clearfix">
											...
											<li class="col-md-4">
                               				...
                               				<li class="col-md-4">
	                            				<label class="titname">余额变动时间：</label>
                                ...
                                <table class="table-striped table-hover table-bordered" id="olv_tab" style="width: 100%;background-color: #fff;margin-bottom: 0;">
                                    <thead>
                                        <tr role="row" style='height:35px;'>
                                            ...
                                            <th width="2%" style="text-align: center;" >总余额</th>
                                            <th width="2%" style="text-align: center;">可用余额</th>
								...
								{#template MAIN}
									{#foreach $T.object.data as Result}
										<tr class="gradeX" id="gradeX{$T.Result.sid}" ondblclick="trClick('{$T.Result.orderTradeNo}',this)" style="height:35px;">
											...
											<td align="center">
												{#if $T.Result.act_balance!= '[object Object]'}{$T.Result.act_balance}
												{#/if}
											</td>
											<td align="center">
