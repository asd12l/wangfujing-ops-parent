                                ...
                                <div style="width:100%; height:0%; min-height:300px; overflow-Y:hidden;">
                                    <table class="table-striped table-hover table-bordered"
                                        ...
                                        <tr role="row" style='height: 35px;'>
                                            ...
                                            <th style="text-align: center;" width="5%">单据状态</th>
...
<div class="modal modal-darkorange" id="addIntegralDiv">
    <div class="modal-dialog"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close"
                        type="button" onclick="closeAddIntegral();">×
                </button>
...
<div class="modal modal-darkorange" id="editIntegralDiv">
    <div class="modal-dialog"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close"
                        type="button" onclick="closeEditIntegral();">×
                </button>
                    ...
                    <form method="post" class="form-horizontal">
                        <div class="col-xs-12 col-md-12">
                            <div class="col-md-12" style="padding: 10px 100px;">
                                    ...
                                    <div class="radio">
                                        <label> <input class="basic divtype cart_flag"
                                                       ...
                                                       value="1" checked="checked"> <span class="text">增积分</span>
                                                                ...
                                                                type="radio" id="edit_applyType_1"
                                                                name="apply_type_edit"
                                    ...
                                    <div class="radio">
                                        <label> <input class="basic divtype cart_flag"
                                                       ...
                                                       value="1" checked="checked"> <span class="text">订单号</span>
                                                                ...
                                                                type="radio" id="edit_sourceType_1"
                                                                name="source_type_edit"
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="edit_orderNo"
...
<div class="modal modal-darkorange" id="checkIntegralDiv">
    <div class="modal-dialog"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close"
                        type="button" onclick="closeCheckApply();">×
                </button>
...
<div class="modal modal-darkorange" id="showMemberInfoDiv">
    <div class="modal-dialog"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close"
                        type="button" onclick="closeShowMemberView();">×
                </button>
                    ...
                    <form method="post" class="form-horizontal" id="editForm">
                        <div class="col-xs-12 col-md-12">
                            ...
                            <div class="col-md-12" style="padding: 10px 100px;">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="name" id="show_username_input"
                                           readonly="readonly"/>
                                </div>
                                <br>&nbsp;
                            </div>
