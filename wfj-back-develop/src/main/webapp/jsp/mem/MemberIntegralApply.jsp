                        ...
                        <div class="widget-body" id="pro">
                            <div class="table-toolbar">
                                ...
                                <div class="mtb10">
                                    ...
                                    <a onclick="editIntegralApply();" class="btn btn-info"> <i class="fa fa-wrench"></i>编辑积分申请</a>&nbsp;&nbsp;
                                    <a onclick="showCheckApply();" class="btn btn-info"> <i class="fa fa-wrench"></i>审核积分申请</a>&nbsp;&nbsp;
                                    <a onclick="cancleApply();" class="btn btn-info"> <i class="fa fa-wrench"></i>取消积分申请</a>&nbsp;&nbsp;
                                </div>
										...
										{#template MAIN}
											{#foreach $T.list as Result}
												<tr class="gradeX">
													...
													<td align="center" id="apply_point_{$T.Result.sid}">
                                                        {#if $T.Result.apply_point_num== "" || $T.Result.apply_point_num == null}--
                                                        {#else}
														{#if $T.Result.apply_type == "2"}-{$T.Result.apply_point_num}
