                        ...
                        <div class="widget-body">
                            <form id="theForm" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="setupComplaintBal" maxlength="10" onblur="checkStr()" value="${param.setupComplaintBal }" name="setupComplaintBal" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">运费补偿额度</label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="setupCarriageBal" maxlength="10" onblur="checkStr()" value="${param.setupCarriageBal }" name="setupCarriageBal" />
                                    </div>
                                </div>
                                <div class="form-group">
