								...
								{#template MAIN}
									{#foreach $T.object.resList as Result}
										...
										<td align="center">
												...
												<input type="hidden" id="bankCardNo_{$T.Result.sid}"
                                                       value="{$T.Result.bankCardNo}">
												<input type="hidden" id="withdrowReason_{$T.Result.sid}"
                                                       value="{$T.Result.withdrowReason}">
												<input type="hidden" id="seqno_{$T.Result.sid}"
                                                       value="{$T.Result.seqno}">
												<input type="hidden" id="billno_{$T.Result.sid}"
                                                       value="{$T.Result.billno}">
												<input type="hidden" id="mobile_{$T.Result.sid}"
                                                       value="{$T.Result.mobile}">
												<input type="hidden" id="applyName_{$T.Result.sid}"
                                                       value="{$T.Result.applyName}">
												{#if $T.Result.refundStatus == '1'}
												 <a href="javascript:editMerchant({$T.Result.sid});">
														    <span class="btn btn-blue"><i
                                                                    class="fa fa-edit"></i>查看</span>
														</a>
				                   				{#/if}
											...
											<td align="center" id="mobileStr_{$T.Result.sid}"
                                                value="{$T.Result.mobileStr}">
												{#if $T.Result.mobileStr!= '[object Object]'}{$T.Result.mobileStr}
				                   				{#/if}
											</td>
											<td align="center" id="applyNameStr_{$T.Result.sid}"
                                                value="{$T.Result.applyNameStr}">
											...
											<td align="center" id="applyTimeStr_{$T.Result.sid}"
                                                value="{$T.Result.applyTimeStr}">
												{#if $T.Result.applyTimeStr!= '[object Object]'}{$T.Result.applyTimeStr}
				                   				{#/if}
											</td>
											<td align="center" id="withdrowReason_{$T.Result.sid}"
                                                value="{$T.Result.withdrowReason}">
											...
											<td align="center" id="bank_{$T.Result.sid}" value="{$T.Result.bank}">
			                   				...
			                   				<td align="center" id="bankCardNoStr_{$T.Result.sid}"
                                                value="{$T.Result.bankCardNoStr}">
												{#if $T.Result.bankCardNoStr != '[object Object]'}{$T.Result.bankCardNoStr}
				                   				{#/if}
			                   				</td>
											<td align="center" id="withdrowMoney_{$T.Result.sid}"
                                                value="{$T.Result.withdrowMoney}">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close"
                        type="button" onclick="closeMerchant();">×
                </button>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-4 col-lg-7">
                            <button onclick="checkPass();" style="width: 90px;" id="pass" type="button">退款完成
                            </button>
                            &emsp;&emsp;&emsp;&emsp;
                            <button onclick="checknopass();" style="width: 90px;" id="nopass" type="button">退款失败
                            </button>
                        </div>
                    </div>
                </div>
...
<div class="modal modal-darkorange" style="background: 0.5, 0.5, 0.5;"
    ...
    <div class="modal-dialog"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close"
                        type="button" onclick="closeMerchant22();">×
                </button>
                <h4 class="modal-title" id="divTitle">查看提现申请</h4>
            </div>
            <div class="page-body" id="pageBodyRight">
...
<div class="modal modal-darkorange" style="background: 0.5, 0.5, 0.5;"
    ...
    <div class="modal-dialog"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close"
                        type="button" onclick="closeMerchant1();">×
                </button>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-4 col-lg-7">
                            <button style="width: 90px;" id="edit"
                                    type="button" onclick="nopasstrue();">确认
                            </button>
                            &emsp;
