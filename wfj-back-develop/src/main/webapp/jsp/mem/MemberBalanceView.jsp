 ...
 color:red;
  ...
  <script type="text/javascript">
	...
	function query() {
    	...
    	LA.sysCode = '64';
		LA.log('memberBlance-query', '余额记录', userName,  sessionId);
		$("#cache").val(0);
		productQuery();
	}
	//重置
	function reset(){
		userName = getCookieValue("username");
    	LA.sysCode = '64';
		LA.log('memberBlance-query', '余额记录重置', userName,  sessionId);
		$("#cache").val(1);
		$("#username").val("");
		$("#mobile_input").val("");
	...
	//初始化包装单位列表
 	function initOlv() {
		var url = __ctxPath+"/memberAccount/getByMemberBalance";
	...
	function successBtn(){
		...
		$("#pageBody").load(__ctxPath+"/jsp/mem/MemberBalanceView.jsp");
	}
</script>
<!-- 加载样式 -->
<script type="text/javascript">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <h5 class="widget-caption">余额记录</h5>
                                ...
                                <div class="widget-body" id="pro">
                                    <div class="table-toolbar">
                                    		<div class="mtb10">
                                    		<span class="titname">余额变动时间：</span> <input type="text" id="reservation" />
                                   ...
                                   <table class="table table-bordered table-striped table-condensed table-hover flip-content"
									id="olv_tab" style="width: 200%;background-color: #fff;margin-bottom: 0;">
                                        <thead>
											...
											<th style="text-align: center;" width="10%">时间（余额变动）</th>
											<th style="text-align: center;" width="10%">会员来源</th>
											<th style="text-align: center;" width="10%">会员等级</th>
											<th style="text-align: center;" width="10%">余额类别</th>
