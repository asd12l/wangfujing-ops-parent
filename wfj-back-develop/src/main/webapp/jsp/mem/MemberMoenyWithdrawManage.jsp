									...
									{#foreach $T.object.resList as Result}
										<tr class="gradeX" id="gradeX{$T.Result.sid}"
											...
											<td align="center">
												...
												<input type="hidden" id="bankCardNoStr_{$T.Result.sid}"
                    ...
                    <div class="form-group" style="width: 600px">
                        <div class="col-lg-offset-4 col-lg-7" style="width: auto;margin-left: 80px;">
                            <button style="width: 80px;float: left;" id="edit"
                                    type="button" onclick="editform();">保存
                            </button>
                            &emsp;
                            <button onclick="giveup();" style="width: 80px;float: left;" id="cancel" type="button">取消
                            </button>
                            &emsp;
                            <button onclick="checkPass();" style="width: 90px;float: left;" id="pass" type="button">
                                审核通过
                            </button>
                            &emsp;
                            <button onclick="checknopass();" style="width: 100px;float: left;" id="nopass"
                                    type="button">审核不通过
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-4 col-lg-7">
                            <button style="width: 90px;" id="edit"
                                    type="button" onclick="giveuptrue();">确认
                            </button>
                            &emsp;
...
<div class="modal modal-darkorange" style="background: 0.5, 0.5, 0.5;"
    ...
    <div class="modal-dialog"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close"
                        type="button" onclick="closeMerchant2();">×
                </button>
