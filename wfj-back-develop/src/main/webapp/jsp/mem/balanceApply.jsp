									...
									{#foreach $T.object as Result}
										<tr class="gradeX" id="gradeX{$T.Result.sid}" ondblclick="trClick('{$T.Result.orderTradeNo}',this)" style="height:35px;">
											...
											<td align="center" id="memberAccount_{$T.Result.sid}" >
												{#if $T.Result.memberAccount != '[object Object]'}{$T.Result.memberAccount}
				                   				{#/if}
											</td>
											...
											<td align="center" id="applyTime_{$T.Result.sid}">
												{#if $T.Result.applyTime!= '[object Object]'}{formatDate($T.Result.applyTime)}
				                   				{#/if}
											</td>
			...
			<div class="modal-content">
				<div class="modal-header">
					<button aria-hidden="true" data-dismiss="modal" class="close"
						type="button" onclick="closeDialog();">×</button>
