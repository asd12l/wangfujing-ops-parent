...
function findMediumType(type){
	var bpIdDateUrl=__ctxPath+"/wfjpay/payMedium/selectPayTypeList";
	$.post(bpIdDateUrl,function(data){
		var option="";
		if(data.success){
...
//设置二级介质
function setSubMedium(code){
	supCode=code;
	supName=$("#name_"+code).text().trim();
	var url = __ctxPath + "/jsp/pay/payMedium/subMediumList.jsp";
	$("#pageBody").load(url);
}
...
var validateUrl=__ctxPath+"/wfjpay/valid/valStringLength";
//表单验证
$(function(){
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <h5 class="widget-caption">支付介质管理</h5>
                                ...
                                <table class="table-striped table-hover table-bordered" id="olv_tab" style="width: 100%;background-color: #fff;margin-bottom: 0;">
                                    <thead>
                                        <tr role="row" style='height:35px;'>
                                            <th width="2%" style="text-align: center;min-width:100px;">一级介质码</th>
                                            <th width="3%" style="text-align: center;min-width:150px;">一级介质名称</th>
									...
									{#foreach $T.list as Result}
										<tr class="gradeX" id="gradeX{$T.Result.code}" onclick="" style="height:35px;">
											...
											<td align="center" >
												...
												<a class="btn btn-default purple btn-sm fa fa-cog" onclick='setSubMedium("{$T.Result.code}");'> 设置二级介质</a>
											</td>
							       		</tr>
									{#/for}
							    {#/template MAIN}	
			...
			<form  id="addForm" method="post" class="form-horizontal" enctype="multipart/form-data">  
			    <div class="widget-body" >
					<div class="form-group" >
						<div class=" ">
							<label class="col-lg-5 col-sm-5 col-xs-5 control-label">一级介质码：</label>
					...
					<div class="form-group">
						<div class="">
							<label class="col-lg-5 col-sm-5 col-xs-5 control-label">一级介质名称：</label>
							<div class="col-lg-6 col-sm-6 col-xs-6">
...
<div class="modal modal-darkorange" id="editDiv">
	<div class="modal-dialog" style="width: 500px;height:400px;margin: 10% auto;">
	    <div class="modal-content">
		    <div class="widget-header">
				<span class="widget-caption">修改一级介质</span>
