						...
						<div class="widget radius-bordered">
							...
							<div class="widget-body">
								<form id="theForm" method="post" class="form-horizontal">
									<input type="hidden" name="sid" value="${json.record.sid }"/>
									<input type="hidden" name="username" value="${json.record.lastOptUser }"/>
									
									<div class="form-group">
										<label class="col-lg-3 control-label">门店名称：</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" id="shopName" name="shopName" value="${json.record.shopName }" placeholder="必填"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="contactPerson" name="contactPerson" value="${json.record.contactPerson }" placeholder="必填"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="address" name="address" value="${json.record.address }" placeholder="必填"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="mailbox" name="mailbox" value="${json.record.mailbox }" placeholder="必填"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="phone" name="phone" value="${json.record.phone }" placeholder="必填"/>
										</div>
									</div>
