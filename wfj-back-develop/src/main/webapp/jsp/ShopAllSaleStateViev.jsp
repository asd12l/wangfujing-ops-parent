...
<script type="text/javascript">
	...
	function initOlv() {
		var url = __ctxPath + "/statement/shopAllSaleController";
	...
	function exportExcel(){
		...
		var title = "SHOPIN"+saleTimeFrom+"To"+saleTimeTo+"SHOPSALEANDREFUND";
		var count =  $("#olv_tab tbody tr").length;
		if(count>0&&saleTimeFrom!=""&&saleTimeTo!=""){
			window.open(__ctxPath+"/stateExcel/shopAllSaleToExcel?saleTimeFrom="+saleTimeFrom+"&&saleTimeTo="+saleTimeTo+"&&title="+title);
		}else{
	...
	function exportPDF(){
		...
		var count =  $("#olv_tab tbody tr").length;
		if(count>0&&saleTimeFrom!=""&&saleTimeTo!=""){
			window.open(__ctxPath+"/statePDF/shopAllSaleToPDF?saleTimeFrom="+saleTimeFrom+"&&saleTimeTo="+saleTimeTo+"&&title="+title);
		}else{
					...
					<div class="col-xs-12 col-md-12">
						<div class="widget">
							<div class="widget-header ">
								<span class="widget-caption"><h5>网站每日销售管理</h5>
								</span>
