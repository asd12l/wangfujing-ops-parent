...
/**
 * 会员基本信息展示 Created by shenjp on 2016/6/6.
 */
@Controller
...
public class MemberBasicController {
	...
	public String relieveBlackList(HttpServletRequest request, HttpServletResponse response) {
	...
	public String editBlackList(HttpServletRequest request, HttpServletResponse response) {
	...
	public String getBlackList(HttpServletRequest request, HttpServletResponse response) {
		...
		;
		pageSize = request.getParameter("pageSize") == null ? null : Integer.parseInt(request.getParameter("pageSize"));
	...
	public String pullBlackList(HttpServletRequest request, HttpServletResponse response) {
	...
	public String getMemBasicInfo(HttpServletRequest request, HttpServletResponse response) {
		...
		log.info("member getMemBasicInfo的请求参数:cid:" + request.getParameter("cid") + ",belongStore:"
				+ request.getParameter("belongStore") + ",mobile:" + request.getParameter("mobile") + ",idType:"
				+ request.getParameter("idType") + ",identityNo:" + request.getParameter("identityNo") + ",email:"
				+ request.getParameter("email") + ",timeStartDate:" + request.getParameter("timeStartDate")
				+ ",timeEndDate:" + request.getParameter("timeEndDate") + ",memberLevel:"
				+ request.getParameter("memberLevel"));

		Map<String, Object> paraMap = new HashMap<String, Object>();

		/*
		 * //获取value值0或1,1隐藏，0不隐藏 List<String> paramKeys = new
		 * ArrayList<String>(); paramKeys.add("memberInfo"); List<SysConfig>
		 * list = isysConfigService.selectByKeys(paramKeys); String value="";
	...
	public String sendPayCodeToPhone(HttpServletRequest request, HttpServletResponse response) {
	...
	public String sendPayPwdToPhone(HttpServletRequest request, HttpServletResponse response) {
	...
	public String sendLoginCodeToPhone(HttpServletRequest request, HttpServletResponse response) {
	...
	public String getMemPurchase(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (resJson != null && !"".equals(resJson)) {
				...
				jsonString = "{success :false}";
				log.error("======== getMemRefund url " + url + "  =========" + "查询结果为空！");
			}
	...
	public String getMemRefund(HttpServletRequest request, HttpServletResponse response) {
	...
	public String selectOrderFrom(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			json = HttpUtilPcm.doPost(SystemConfig.SSD_SYSTEM_URL + "/pcmAdminChannel/findListChannel.htm",
