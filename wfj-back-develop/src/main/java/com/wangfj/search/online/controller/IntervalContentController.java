...
public class IntervalContentController {
	...
	public String getAllIntervalContent(HttpServletRequest request) {
		...
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "获取后台服务地址失败, ICC0087");
			return json.toJSONString();
		}
		...
		if (StringUtils.isBlank(address)) {
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "后台无活动的服务节点, ICC0094");
			return json.toJSONString();
		}
		...
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "获取后台服务地址失败, ICC0105");
			return json.toJSONString();
		}
		...
		if (StringUtils.isBlank(address2)) {
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "后台无活动的服务节点, ICC0112");
			return json.toJSONString();
		}
		...
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "请求后台服务失败, ICC0125");
			return json.toJSONString();
		}
	...
	public String getChannelsList(HttpServletRequest request) {
		...
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "签名处理失败, ICC0160");
			return json.toJSONString();
		}
		Optional<String> serviceAddress;
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "获取后台服务地址失败, ICC0170");
			return json.toJSONString();
		}
		String address = serviceAddress.orNull();
		if (StringUtils.isBlank(address)) {
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "后台无活动的服务节点, ICC0177");
			return json.toJSONString();
		}
		String resultJson;
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "请求后台服务失败, ICC0187");
			return json.toJSONString();
		}
	...
	public String updateIntervalContent(HttpServletRequest request, String sid, String channel) {
		...
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "签名处理失败, ICC0210");
			return json.toJSONString();
		}
		Optional<String> serviceAddress;
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "获取后台服务地址失败, ICC0220");
			return json.toJSONString();
		}
		String address = serviceAddress.orNull();
		if (StringUtils.isBlank(address)) {
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "后台无活动的服务节点, ICC0227");
			return json.toJSONString();
		}
		String resultJson;
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "请求后台服务失败, ICC0237");
			return json.toJSONString();
		}
		JSONObject Json = JSONObject.parseObject(resultJson);
		return Json.toString();
	...
	public String saveIntervalContent(HttpServletRequest request, String channel) {
		...
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "签名处理失败, ICC0258");
			return json.toJSONString();
		}
		Optional<String> serviceAddress;
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "获取后台服务地址失败, ICC0268");
			return json.toJSONString();
		}
		String address = serviceAddress.orNull();
		if (StringUtils.isBlank(address)) {
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "后台无活动的服务节点, ICC0275");
			return json.toJSONString();
		}
		String resultJson;
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "请求后台服务失败, ICC0285");
			return json.toJSONString();
		}
		JSONObject Json = JSONObject.parseObject(resultJson);
		return Json.toString();
	...
	public String deleteIntervalContent(HttpServletRequest request, String sid, String field, String show_text, String channel, String selected) {
		...
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "签名处理失败, ICC0310");
			return json.toJSONString();
		}
		Optional<String> serviceAddress;
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "获取后台服务地址失败, ICC0320");
			return json.toJSONString();
		}
		String address = serviceAddress.orNull();
		if (StringUtils.isBlank(address)) {
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "后台无活动的服务节点, ICC0327");
			return json.toJSONString();
		}
		String resultJson;
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "请求后台服务失败, ICC0337");
			return json.toJSONString();
		}
		JSONObject Json = JSONObject.parseObject(resultJson);
		return Json.toString();
	...
	public String toSelected(HttpServletRequest request, String sid, String field, String show_text, String channel, String selected) {
		...
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "签名处理失败, ICC0362");
			return json.toJSONString();
		}
		Optional<String> serviceAddress;
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "获取后台服务地址失败, ICC0372");
			return json.toJSONString();
		}
		String address = serviceAddress.orNull();
		if (StringUtils.isBlank(address)) {
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "后台无活动的服务节点, ICC0379");
			return json.toJSONString();
		}
		String resultJson;
		try {
			...
			JSONObject json = new JSONObject();
			json.put("success", false);
			json.put("message", "请求后台服务失败, ICC0389");
			return json.toJSONString();
		}
		JSONObject Json = JSONObject.parseObject(resultJson);
		return Json.toString();
