 ...
 * @author haowenchao
 */
public class ExcelOrderVo implements Serializable {
	...
	public String toString() {
		return "ExcelOrderVo [bpOrderId=" + bpOrderId + ", bpName=" + bpName
				+ ", orderTradeNo=" + orderTradeNo + ", createDate="
				+ createDate + ", payDate=" + payDate + ", content=" + content
				+ ", account=" + account + ", totalFee=" + totalFee
				+ ", payType=" + payType + ", payTypeName=" + payTypeName
				+ ", paySerialNumber=" + paySerialNumber + ", status=" + status
				+ ", statusName=" + statusName + ", detailUrl=" + detailUrl
				+ ", operationUrl=" + operationUrl + ", payBank=" + payBank
				+ ", goodsName=" + goodsName + ", payAccount=" + payAccount
				+ ", unid=" + unid + ", nickname=" + nickname
				+ ", payNickname=" + payNickname + ", showUrl=" + showUrl
				+ ", bpId=" + bpId + ", initOrderTerminal=" + initOrderTerminal
				+ ", initOrderTerminalName=" + initOrderTerminalName
				+ ", finalPayTerminal=" + finalPayTerminal
				+ ", channelFeeCost=" + channelFeeCost + ", payIp=" + payIp
				+ ", payService=" + payService + ", needPayPrice="
				+ needPayPrice + ", bargainIncome=" + bargainIncome
				+ ", payCurrency=" + payCurrency + ", merCode=" + merCode
				+ ", userName=" + userName + ", createDateFormat="
				+ createDateFormat + "]";
	}

	public ExcelOrderVo(String bpOrderId, String bpName, String orderTradeNo,
			Long createDate, Long payDate, String content, String account,
			Double totalFee, String payType, String payTypeName,
			String paySerialNumber, Long status, String statusName,
			String detailUrl, String operationUrl, String payBank,
			String goodsName, String payAccount, String unid, String nickname,
			String payNickname, String showUrl, Long bpId,
			...
			String payCurrency, String merCode, String userName,
			Timestamp createDateFormat) {
		super();
		this.bpOrderId = bpOrderId;
		this.bpName = bpName;
		this.orderTradeNo = orderTradeNo;
	...
	public ExcelOrderVo(String bpOrderId, String bpName,
