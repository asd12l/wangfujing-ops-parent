package com.wangfj.wms.controller.stock.support;

public class ExcelStockVo {
	private String saleStock;
	private String edefectiveStock;
	...
	public String toString() {
		return "ExcelStockVo [saleStock=" + saleStock + ", edefectiveStock=" + edefectiveStock
				+ ", returnStock=" + returnStock + ", lockedStock=" + lockedStock
				+ ", supplierName=" + supplierName + ", channelName=" + channelName + ", storeName="
				+ storeName + ", priceType=" + priceType + ", sid=" + sid + ", productCode="
				+ productCode + ", skuCode=" + skuCode + ", spuCode=" + spuCode + ", discountCode="
				+ discountCode + ", erpProductCode=" + erpProductCode + ", modelCode=" + modelCode
				+ ", barCode=" + barCode + ", productName=" + productName + ", productAbbr="
				+ productAbbr + ", supplierCode=" + supplierCode + ", brandCode=" + brandCode
				+ ", brandName=" + brandName + ", brandGroupCode=" + brandGroupCode
				+ ", brandGroupName=" + brandGroupName + ", counterCode=" + counterCode
				+ ", counterName=" + counterName + ", storeCode=" + storeCode + ", manageCategory="
				+ manageCategory + ", colorCode=" + colorCode + ", colorName=" + colorName
				+ ", sizeCode=" + sizeCode + ", stanCode=" + stanCode + ", stanName=" + stanName
				+ ", isSale=" + isSale + ", skuSale=" + skuSale + ", spuSale=" + spuSale
				+ ", manageType=" + manageType + ", stockType=" + stockType + ", materialNum="
				+ materialNum + ", articleNum=" + articleNum + ", isDiscountable=" + isDiscountable
				+ ", isCOD=" + isCOD + ", unitCode=" + unitCode + ", unitName=" + unitName
				+ ", salesPrice=" + salesPrice + ", marketPrice=" + marketPrice
				+ ", maxDiscountRate=" + maxDiscountRate + ", productStatus=" + productStatus
				+ ", operateMode=" + operateMode + ", commissionRate=" + commissionRate
				+ ", originSalesUnit=" + originSalesUnit + ", erpSkuType=" + erpSkuType
				+ ", statCategory=" + statCategory + ", channelSid=" + channelSid
				+ ", priceChannel=" + priceChannel + ", productType=" + productType + ", stockSum="
				+ stockSum + ", tmsParam=" + tmsParam + ", promotionPrice=" + promotionPrice
				+ ", negativeStock=" + negativeStock + ", season=" + season + ", stockMode="
				+ stockMode + ", processType=" + processType + ", originLand=" + originLand
				+ ", orderType=" + orderType + ", isPromotion=" + isPromotion + ", isAdjustPrice="
				+ isAdjustPrice + ", primaryAttr=" + primaryAttr + ", features=" + features
				+ ", sexSid=" + sexSid + ", awesome=" + awesome + ", supplierSid=" + supplierSid
