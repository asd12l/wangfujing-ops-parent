...
public class PcmShoppeAUPara implements Serializable {

	/**
	 * @Field long serialVersionUID
	 */
	private static final long serialVersionUID = -910493658127543367L;
	...
	public String toString() {
		return "PcmShoppeAUPara [sid=" + sid + ", groupSid=" + groupSid + ", shopSid=" + shopSid
				...
				+ supplySid + ", brandSid=" + brandSid + ", fromSystem=" + fromSystem
				+ ", channelSaleConfigParaList=" + channelSaleConfigParaList + "]";
	}
