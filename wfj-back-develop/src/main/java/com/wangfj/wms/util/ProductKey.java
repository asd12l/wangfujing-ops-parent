 ...
 * @Path: com.wangfj.back.viewProductKey.java
 * @Create By chengsj
...
public class ProductKey {
	//====modify by chengsj start (新增关键字字段)
	...
	private String supplySids;//多个供应商编码
	private String supplySid;//单个供应商编码
	//======modify by chengsj end 
	...
	public void setPageLayoutSid(String pageLayoutSid) {
	 ...
	 public String getBrandName() {
		...
		public String toString() {
			return "ProductKey [shopName=" + shopName + ", shopSid=" + shopSid
					+ ", stockMin=" + stockMin + ", stockMax=" + stockMax
					+ ", brandName=" + brandName + ", saleCode=" + saleCode
					+ ", saleSumMin=" + saleSumMin + ", saleSumMax="
					+ saleSumMax + ", proSellingBeginTime="
					+ proSellingBeginTime + ", proSellingEndTime="
					+ proSellingEndTime + ", saleMoneyMin=" + saleMoneyMin
					+ ", saleMoneyMax=" + saleMoneyMax + ", supplySids="
					+ supplySids + ", supplySid=" + supplySid
					+ ", saleCodeSid=" + saleCodeSid + ", productClassSid="
					+ productClassSid + ", brandSid=" + brandSid + ", offMin="
					+ offMin + ", offMax=" + offMax + ", priceMin=" + priceMin
					+ ", priceMax=" + priceMax + ", proBeginTime="
					+ proBeginTime + ", proEndTime=" + proEndTime + ", proSku="
					+ proSku + ", proStockNum=" + proStockNum
					+ ", pageLayoutSid=" + pageLayoutSid + ", nodeName="
					+ nodeName + ", startUpDay=" + startUpDay + ", endUpDay="
					+ endUpDay + ", proDesc=" + proDesc + ", checked="
					+ checked + "]";
		}
