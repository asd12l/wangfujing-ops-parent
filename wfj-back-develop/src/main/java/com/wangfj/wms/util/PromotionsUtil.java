...
public class PromotionsUtil {
	...
	public static Promotions setPromotions(String key, String value,
		...
		if (key.equals("activeTemplateSid") && value != null && !"".equals(value)) {
		...
		if (key.equals("promotionInfo") && value != null && !"".equals(value)) {
			pro.setPromotionInfo(value);
		}
		...
		if (key.equals("cornerPict") && value != null
				&& !"".equals(value)) {
			pro.setCornerPict(value);
		}
		...
		if (key.equals("joins") && value != null
				&& !"".equals(value)) {
			pro.setJoins(Integer.parseInt(value));;
		}
		return pro;
