...
public class OfReturnPaymentsDTO {
	private Long sid;

    private String returnOrderNo;//退货单商品行

    private String salesPaymentNo;//款机支付流水
	...
	public String toString() {
		return "ReturnPayments [sid=" + sid + ", returnOrderNo=" + returnOrderNo
				+ ", salesPaymentNo=" + salesPaymentNo + ", paymentClass=" + paymentClass
				+ ", paymentType=" + paymentType + ", amount=" + amount + ", acturalAmount="
				+ acturalAmount + ", rate=" + rate + ", account=" + account + ", userId=" + userId
				+ ", payFlowNo=" + payFlowNo + ", couponType=" + couponType + ", couponBatch="
				+ couponBatch + ", couponName=" + couponName + ", activityNo=" + activityNo
				+ ", couponRule=" + couponRule + ", couponRuleName=" + couponRuleName + ", remark="
				+ remark + ", cashBalance=" + cashBalance + "]";
	}
}
